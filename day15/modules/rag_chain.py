...
# 兼容直接运行 day15/modules/rag_chain.py 的情况。
# config.py 在 day15 根目录，不在 modules 目录。
    ...
    def answer(self, question: str) -> str:
        ...
        if self.llm:
            ...
            try:
                ...
                # 在线模型可能因为网络、权限、模型名或 base_url 问题在 invoke 时失败。
                # Day 15 是 RAG 基础学习项目，所以失败时不要中断流程，而是切回离线回答。
                self.llm = None
